...
app = Flask(__name__)
app.secret_key = "cualquier_clave_secreta_para_session"  # necesaria para flash y session
...
def list_inspections_route():
    ...
    return render_template('inspection.html', inspections=inspections)
...
def list_users_route():
    users = list_users()  # lista ya con todos los campos incl. RFC, domicilio, contacto, certificado…
